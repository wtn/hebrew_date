...
describe HebrewDate do
  ...
  specify 'from holidays' do
    ...
    expect(HebrewDate.from_holiday(:YOM_HAATZMAUT, 5780).to_date).to eq(Date.new(2020, 4, 29))
    expect(HebrewDate.from_holiday(:YOM_HAZIKARON, 5780).to_date).to eq(Date.new(2020, 4, 28))
    expect(HebrewDate.from_holiday(:YOM_HAATZMAUT, 5781).to_date).to eq(Date.new(2021, 4, 15))
    expect(HebrewDate.from_holiday(:YOM_HAZIKARON, 5781).to_date).to eq(Date.new(2021, 4, 14))
